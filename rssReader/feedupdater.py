...
#               flist=datatable.Feed.query.filter(sql.and_(datatable.Feed.updateInterval!=-1, 
#                                       sql.func.strftime('%s', datatable.Feed.lastUpdated, 'utc')+\
#                                                               datatable.Feed.updateInterval*60<now_stamp)).\
#                                       filter(datatable.Feed.xmlUrl!=None)
...
#               flist=datatable.Feed.query.filter(sql.and_(datatable.Feed.updateInterval==-1, 
#                                                                 datatable.Feed.lastUpdated < cutoff)).\
#                                                                 filter(datatable.Feed.xmlUrl!=None).\
#                                                                 order_by(datatable.Feed.lastUpdated)
